...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1A0F0A] via-[#1A0F0A] to-[#2D1B1B] relative overflow-hidden" onClick={() => router.push('/auth/register')}>
      <div className="absolute inset-0 hero-pattern">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#C9A84C]/5 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#C9A84C]/3 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }} />
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 lg:py-28">
        ...
        >
          {[
            ...
            { icon: '🔓', title: 'KES 98/Unlock', desc: 'M-Pesa payment', color: 'from-yellow-500/10 to-orange-500/10' },
            { icon: '💸', title: 'Instant Withdraw', desc: 'Withdraw after 6 unlocks', color: 'from-pink-500/10 to-rose-500/10' },
          ].map((feature, index) => (
            <motion.div
              key={index}
